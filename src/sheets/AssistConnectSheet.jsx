...
import { SheetShell, LogoMark, Eyebrow, GradientText, Callout, useIsMobile } from './ui'
  ...
  return (
    <div style={{ boxSizing: 'border-box', padding: '22px 18px 26px', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: t.muted }}>From first click or call to the revenue generated by the completed job</div>
