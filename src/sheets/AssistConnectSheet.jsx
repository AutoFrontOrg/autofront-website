...
function AssistConnectA4({ t }) {
  return (
    <div style={{ height: '100%', boxSizing: 'border-box', padding: '8mm 12mm', display: 'flex', flexDirection: 'column', gap: '3.5mm' }}>
      ...
      {/* Journey diagram */}
      <div style={{ flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: 8, padding: '6mm 0' }}>
        <div style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: t.muted }}>From first click or call to the revenue generated by the completed job</div>
          ...
          {JOURNEY.map((s, i) => (
            <div key={s.label} style={{ display: 'flex', alignItems: 'center', gap: 4, flex: i === JOURNEY.length - 1 ? '0 0 auto' : '1 1 auto' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, flex: '0 0 auto' }}>
                <div style={{ width: 34, height: 34, borderRadius: '50%', background: t.tint(s.color, t.mode === 'dark' ? '22' : '12'), border: `1px solid ${t.tintBorder(s.color)}`, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <s.icon size={17} color={s.color} />
                </div>
                <span style={{ fontSize: 9.5, fontWeight: 700, color: t.heading, whiteSpace: 'nowrap' }}>{s.label}</span>
              </div>
              {i < JOURNEY.length - 1 && <div style={{ flex: '1 1 auto', height: 1.5, background: t.border, minWidth: 4 }} />}
            </div>
          ))}
        </div>
      </div>
